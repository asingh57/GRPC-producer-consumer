 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void getProducts(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::store::ProductReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_getProducts : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_getProducts() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::store::ProductQuery, ::store::ProductReply>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::store::ProductQuery, ::store::ProductReply>*>(handler)
